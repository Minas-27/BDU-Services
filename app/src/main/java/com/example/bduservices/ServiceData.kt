...
object ServiceData {
    val categories = listOf(
        ...
        Category(
            ...
            "ፍራፍሬዎች",
            services = listOf(
                Service(id = 801, "ሙዝ 1 ኪ.ግ", "70"),
                Service(id = 802, "ብርቱካን 1 ኪ.ግ", "150"),
                Service(id = 803, "አቮካዶ 1 ኪ.ግ", "50"),
                Service(id = 804, "ፓፓያ 1 ኪ.ግ", "75"),
                Service(id = 805, "ሀብሀብ 1 ኪ.ግ", "40"),
                Service(id = 806, "አፕል 1 ኪ.ግ", "90")
            ),
            R.drawable.fruit
        ),
